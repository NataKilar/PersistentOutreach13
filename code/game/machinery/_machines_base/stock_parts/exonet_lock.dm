/obj/item/weapon/stock_parts/exonet_lock
...
/obj/item/weapon/stock_parts/exonet_lock/Initialize()
	. = ..()
	set_extension(src, /datum/extension/exonet_device)

/obj/item/weapon/stock_parts/exonet_lock/emag_act(remaining_charges, mob/user, emag_source)
	. = ..()
...
/obj/item/weapon/stock_parts/exonet_lock/on_install(obj/machinery/machine)
	. = ..()
	// Boot up the network.
	if(ennid)
...
/obj/item/weapon/stock_parts/exonet_lock/on_uninstall(obj/machinery/machine)
	. = ..()
	// Remove from network.
	var/datum/extension/exonet_device/exonet = get_extension(src, /datum/extension/exonet_device)
...
/obj/item/weapon/stock_parts/exonet_lock/get_req_access()
	var/datum/extension/exonet_device/exonet = get_extension(src, /datum/extension/exonet_device)
...
/obj/item/weapon/stock_parts/exonet_lock/attackby(obj/item/I, mob/user)
	if(istype(I, /obj/item/modular_computer))
		...
		if(os)
			...
			var/obj/item/weapon/stock_parts/computer/rfid_programmer/programmer = os.get_component(/obj/item/weapon/stock_parts/computer/rfid_programmer)
			if(programmer && programmer.check_functionality())
				programmer.link_device(user, src)
				return TRUE
					

/obj/item/weapon/stock_parts/exonet_lock/proc/get_default_access()
	if(auto_deny_all)
...
/decl/stock_part_preset/exonet_lock/do_apply(obj/machinery/machine, obj/item/weapon/stock_parts/exonet_lock/part)
