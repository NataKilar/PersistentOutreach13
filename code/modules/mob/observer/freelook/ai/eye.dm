...
/mob/observer/eye/visualnet/cameranet
	name = "Inactive Camera Eye"
	name_sufix = "Camera Eye"

/mob/observer/eye/visualnet/cameranet/New()
	..()
	visualnet = cameranet

/mob/observer/eye/visualnet/aiEye
	name = "Inactive AI Eye"
	name_sufix = "AI Eye"
	icon_state = "AI-eye"

/mob/observer/eye/visualnet/aiEye/New()
	..()
	visualnet = cameranet

/mob/observer/eye/visualnet/aiEye/setLoc(var/T, var/cancel_tracking = 1)
	. = ..()
	if(. && isAI(owner))
...
/mob/observer/eye/visualnet/aiEye/set_dir(new_dir)
	. = ..()
	if(. && isAI(owner))
		var/mob/living/silicon/ai/ai = owner
...
/mob/living/silicon/ai/proc/create_eyeobj(var/newloc)
	...
	eyeobj = new /mob/observer/eye/visualnet/aiEye(newloc)
	eyeobj.possess(src)
