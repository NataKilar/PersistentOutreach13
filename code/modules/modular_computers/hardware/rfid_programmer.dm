/obj/item/weapon/stock_parts/computer/rfid_programmer
...
/obj/item/weapon/stock_parts/computer/rfid_programmer/proc/link_device(var/mob/usr, var/obj/target)
	linked_device = target
	if(target)
		to_chat(usr, "\The [src] chirps in acknowledgement as it's linked to \a [target].")


/obj/item/weapon/stock_parts/computer/rfid_programmer/proc/get_device()
	if(!linked_device)
		return
